...
public class SmsController {
     ...
     * 단일 메시지 발송 예제
     */
    @PostMapping("/send-one")      //샌드원을 호출할때 phonenum을 넣어서 입력받은 번호로 인증번호 받기 파라미터로 받는 번호로 인증번호를 보낸다 
    public HashMap<String,Object> sendOne(@RequestParam("phoneNum") String PhoneNum){
        ...
        message.setText("[본인확인 인증]인증번호"  + ranStr +"를 입력하세요 ");
    ...
    // 0~9 랜덤 숫자 뽑아서 5번 이어 붙이기  숫자를 문자열로 바꿔준다 인티저 투 스트링 넘 
